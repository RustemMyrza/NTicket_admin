...
@section('content')
    <div class="card-body">
        ...
        @endif
        <form method="POST" action="{{route('analytics-seo-store')}}" accept-charset="UTF-8"
              class="form-horizontal" enctype="multipart/form-data">
            {{ csrf_field() }}

            <input type="hidden" name="analytics_id" value="{{$analytics->id}}">
            ...
            <div class="tab-content col-md-12" id="custom-tabs-one-tabContent">
                <div class="tab-pane active in" id="custom-tabs-one-ru" role="tabpanel"
                    ...
                    <div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
                        ...
                        <textarea class="form-control" name="title[ru]" type="text"
                                  id="title_ru">{{ isset($analytics->metaTitle->ru) ? $analytics->metaTitle->ru : old('title.ru')}}</textarea>
                ...
                {{ isset($analytics->metaDescription->ru) ? $analytics->metaDescription->ru : old('content.ru')}}
            </textarea>
                ...
                <div class="tab-pane fade" id="custom-tabs-one-en" role="tabpanel"
                    ...
                    <div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
                        ...
                        <input class="form-control" name="title[en]" type="text" id="title_en"
                               value="{{ isset($analytics->metaTitle->en) ? $analytics->metaTitle->en : old('title.en')}}">
                ...
                {{ isset($analytics->metaDescription->en) ? $analytics->metaDescription->en : old('content.en')}}
            </textarea>
                        {!! $errors->first('content[ru]"', '<p class="help-block">:message</p>') !!}
                    </div>
                </div>
                ...
                <div class="tab-pane fade" id="custom-tabs-one-kz" role="tabpanel"
                    ...
                    <div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
                        ...
                        <input class="form-control" name="title[kz]" type="text" id="title_kz"
                               value="{{ isset($analytics->metaTitle->kz) ? $analytics->metaTitle->kz : old('title.kz')}}">
                ...
                {{ isset($analytics->metaDescription->kz) ? $analytics->metaDescription->kz : old('content.kz')}}
            </textarea>
                ...
                <div class="tab-pane fade" id="custom-tabs-one-tr" role="tabpanel"
                    ...
                    <div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
                        ...
                        <input class="form-control" name="title[tr]" type="text" id="title_tr"
                               value="{{ isset($analytics->metaTitle->tr) ? $analytics->metaTitle->tr : old('title.tr')}}">
                ...
                {{ isset($analytics->metaDescription->tr) ? $analytics->metaDescription->tr : old('content.tr')}}
            </textarea>
                ...
                <div class="tab-pane fade" id="custom-tabs-one-ch" role="tabpanel"
                    ...
                    <div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
                        ...
                        <input class="form-control" name="title[ch]" type="text" id="title_ch"
                               value="{{ isset($analytics->metaTitle->ch) ? $analytics->metaTitle->ch : old('title.ch')}}">
                ...
                {{ isset($analytics->metaDescription->ch) ? $analytics->metaDescription->ch : old('content.ch')}}
            </textarea>
                ...
                <div class="tab-pane fade" id="custom-tabs-one-phr" role="tabpanel"
                    ...
                    <div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
                        ...
                        <input class="form-control" name="title[phr]" type="text" id="title_phr"
                               value="{{ isset($analytics->metaTitle->phr) ? $analytics->metaTitle->phr : old('title.phr')}}">
                ...
                {{ isset($analytics->metaDescription->phr) ? $analytics->metaDescription->phr : old('content.phr')}}
            </textarea>

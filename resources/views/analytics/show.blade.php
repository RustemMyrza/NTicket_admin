...
@section('content')
    ...
    <div class="card-body">
        ...
        <a href="{{ url('/admin/banner/' . $banner->id . '/edit') }}" title="Редактировать баннер"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-alt" aria-hidden="true"></i> Редактировать</button></a>
        ...
        <div class="table-responsive">
            <table class="table">
                <tbody>
                    ...
                    <tr>
                        <th> Иконка </th>
                        <td> <img src="{{ \Config::get('constants.alias.cdn_url').$banner->icon }}" alt="" width="50px;"> </td>
                    </tr>
                    <tr>
                        <th> Изображение </th>
                        <td> <img src="{{ \Config::get('constants.alias.cdn_url').$banner->image }}" alt="" width="300px;"> </td>
                    </tr>
                    <tr>
                        <th> Ссылка </th>
                        <td> {{ $banner->url }} </td>

...
@section('content')
    <div class="card-body">
        ...
        <div class="table-responsive">
                ...
                @foreach($analytics as $item)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ url('/admin/analytics/' . $item->id . '/edit') }}" title="Редактировать"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-alt" aria-hidden="true"></i> Редактировать</button></a>

                            <form method="POST" action="{{ url('/admin/analytics' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                {{ method_field('DELETE') }}
                                {{ csrf_field() }}
            ...
            <div class="pagination-wrapper"> {!! $analytics->appends(['search' => Request::get('search')])->render() !!} </div>
        </div>
    </div>
@endsection
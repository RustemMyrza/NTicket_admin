    ...
    <div class="tab-pane fade" id="custom-tabs-one-ru" role="tabpanel" aria-labelledby="custom-tabs-one-ru-tab">
        <div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
            ...
            <input class="form-control" name="title[ru]" type="text" id="title_ru"
                   value="{{ isset($partner_blocks->getTitle->ru) ? $partner_blocks->getTitle->ru : old('title.ru')}}">
        ...
        <div class="form-group {{ $errors->has('content') ? 'has-error' : ''}}">
            ...
            <input class="form-control" name="content[ru]" type="text" id="content_ru"
                   value="{{ isset($partner_blocks->getContent->ru) ? $partner_blocks->getContent->ru : old('content.ru')}}">
    ...
    <div class="tab-pane fade" id="custom-tabs-one-en" role="tabpanel" aria-labelledby="custom-tabs-one-en-tab">
        <div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
            ...
            <input class="form-control" name="title[en]" type="text" id="title_en"
                   value="{{ isset($partner_blocks->getTitle->en) ? $partner_blocks->getTitle->en : old('title.en')}}">
        ...
        <div class="form-group {{ $errors->has('content') ? 'has-error' : ''}}">
            ...
            <input class="form-control" name="content[en]" type="text" id="content_ru"
                   value="{{ isset($partner_blocks->getContent->en) ? $partner_blocks->getContent->en : old('content.en')}}">
            {!! $errors->first('content[ru]"', '<p class="help-block">:message</p>') !!}
        </div>
    </div>
    ...
    <div class="tab-pane fade" id="custom-tabs-one-kz" role="tabpanel" aria-labelledby="custom-tabs-one-kz-tab">
        <div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
            ...
            <input class="form-control" name="title[kz]" type="text" id="title_kz"
                   value="{{ isset($partner_blocks->getTitle->kz) ? $partner_blocks->getTitle->kz : old('title.kz')}}">
        ...
        <div class="form-group {{ $errors->has('content') ? 'has-error' : ''}}">
            ...
            <input class="form-control" name="content[kz]" type="text" id="content_kz"
                   value="{{ isset($partner_blocks->getContent->kz) ? $partner_blocks->getContent->kz : old('content.kz')}}">
    ...
    <div class="tab-pane fade" id="custom-tabs-one-tr" role="tabpanel" aria-labelledby="custom-tabs-one-tr-tab">
        <div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
            ...
            <input class="form-control" name="title[tr]" type="text" id="title_tr"
                   value="{{ isset($partner_blocks->getTitle->tr) ? $partner_blocks->getTitle->tr : old('title.tr')}}">
        ...
        <div class="form-group {{ $errors->has('content') ? 'has-error' : ''}}">
            ...
            <input class="form-control" name="content[tr]" type="text" id="content_tr"
                   value="{{ isset($partner_blocks->getContent->tr) ? $partner_blocks->getContent->tr : old('content.tr')}}">
    ...
    <div class="tab-pane fade" id="custom-tabs-one-ch" role="tabpanel" aria-labelledby="custom-tabs-one-ch-tab">
        <div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
            ...
            <input class="form-control" name="title[ch]" type="text" id="title_ch"
                   value="{{ isset($partner_blocks->getTitle->ch) ? $partner_blocks->getTitle->ch : old('title.ch')}}">
        ...
        <div class="form-group {{ $errors->has('content') ? 'has-error' : ''}}">
            ...
            <input class="form-control" name="content[ch]" type="text" id="content_ch"
                   value="{{ isset($partner_blocks->getContent->ch) ? $partner_blocks->getContent->ch : old('content.ch')}}">
    ...
    <div class="tab-pane fade" id="custom-tabs-one-phr" role="tabpanel" aria-labelledby="custom-tabs-one-phr-tab">
        <div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
            ...
            <input class="form-control" name="title[phr]" type="text" id="title_phr"
                   value="{{ isset($partner_blocks->getTitle->phr) ? $partner_blocks->getTitle->phr : old('title.phr')}}">
        ...
        <div class="form-group {{ $errors->has('content') ? 'has-error' : ''}}">
            ...
            <input class="form-control" name="content[phr]" type="text" id="content_phr"
                   value="{{ isset($partner_blocks->getContent->phr) ? $partner_blocks->getContent->phr : old('content.phr')}}">
...
<div class="form-group">
    ...
    <input class="form-control" name="queue" id="queue" type="text" value="{{$partner_blocks->queue}}">
</div>

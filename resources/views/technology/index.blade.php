...
@section('content')
    <div class="card-body">
        ...
        <a href="{{ url('/admin/technology/create') }}" class="btn btn-success btn-sm" title="Добавить">
                ...
                @foreach($technology as $item)
                    <tr>
                        ...
                        <!-- <a href="{{ url('/admin/technology/' . $item->id) }}" title="Просмотр слайда"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> Просмотр</button></a> -->
                            <a class="btn btn-success btn-sm" href="{{route('technologies-seo', $item->id)}}">
                                Настроить SEO
                            </a>
                            <a href="{{ url('/admin/technology/' . $item->id . '/edit') }}" title="Редактировать">
                                <button class="btn btn-primary btn-sm"><i class="fa fa-pencil-alt"
                                                                          aria-hidden="true"></i> Редактировать
                                </button>
                            </a>

                            <form method="POST" action="{{ url('/admin/technology' . '/' . $item->id) }}"

...
<div class="tab-content col-md-12" id="custom-tabs-one-tabContent">
    <div class="tab-pane fade" id="custom-tabs-one-ru" role="tabpanel" aria-labelledby="custom-tabs-one-ru-tab">
        <div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
            ...
            <input class="form-control" name="title[ru]" type="text" id="title_ru" value="{{ isset($technology->getTitle->ru) ? $technology->getTitle->ru : old('title.ru')}}" >
            {!! $errors->first('title[ru]', '<p class="help-block">:message</p>') !!}
        </div>
        <div class="form-group {{ $errors->has('content') ? 'has-error' : ''}}">
            <label for="content_ru" class="control-label">{{ 'Описание RU' }}</label>
            <input class="form-control" name="content[ru]" type="text" id="content_ru" value="{{ isset($technology->getContent->ru) ? $technology->getContent->ru : old('content.ru')}}" >
    ...
    <div class="tab-pane fade" id="custom-tabs-one-en" role="tabpanel" aria-labelledby="custom-tabs-one-en-tab">
        <div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
            ...
            <input class="form-control" name="title[en]" type="text" id="title_en" value="{{ isset($technology->getTitle->en) ? $technology->getTitle->en : old('title.en')}}" >
            {!! $errors->first('title[en]', '<p class="help-block">:message</p>') !!}
        </div>
        <div class="form-group {{ $errors->has('content') ? 'has-error' : ''}}">
            <label for="content_ru" class="control-label">{{ 'Описание EN' }}</label>
            <input class="form-control" name="content[en]" type="text" id="content_ru" value="{{ isset($technology->getContent->en) ? $technology->getContent->en : old('content.en')}}" >
            {!! $errors->first('content[ru]"', '<p class="help-block">:message</p>') !!}
        </div>
    </div>
    ...
    <div class="tab-pane fade" id="custom-tabs-one-kz" role="tabpanel" aria-labelledby="custom-tabs-one-kz-tab">
        <div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
            ...
            <input class="form-control" name="title[kz]" type="text" id="title_kz" value="{{ isset($technology->getTitle->kz) ? $technology->getTitle->kz : old('title.kz')}}" >
            {!! $errors->first('title[kz]', '<p class="help-block">:message</p>') !!}
        </div>
        <div class="form-group {{ $errors->has('content') ? 'has-error' : ''}}">
            <label for="content_kz" class="control-label">{{ 'Описание KZ' }}</label>
            <input class="form-control" name="content[kz]" type="text" id="content_kz" value="{{ isset($technology->getContent->kz) ? $technology->getContent->kz : old('content.kz')}}" >
    ...
    <div class="tab-pane fade" id="custom-tabs-one-tr" role="tabpanel" aria-labelledby="custom-tabs-one-tr-tab">
        <div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
            ...
            <input class="form-control" name="title[tr]" type="text" id="title_tr" value="{{ isset($technology->getTitle->tr) ? $technology->getTitle->tr : old('title.tr')}}" >
            {!! $errors->first('title[tr]', '<p class="help-block">:message</p>') !!}
        </div>
        <div class="form-group {{ $errors->has('content') ? 'has-error' : ''}}">
            <label for="content_tr" class="control-label">{{ 'Описание TUR' }}</label>
            <input class="form-control" name="content[tr]" type="text" id="content_tr" value="{{ isset($technology->getContent->tr) ? $technology->getContent->tr : old('content.tr')}}" >
    ...
    <div class="tab-pane fade" id="custom-tabs-one-ch" role="tabpanel" aria-labelledby="custom-tabs-one-ch-tab">
        <div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
            ...
            <input class="form-control" name="title[ch]" type="text" id="title_ch" value="{{ isset($technology->getTitle->ch) ? $technology->getTitle->ch : old('title.ch')}}" >
            {!! $errors->first('title[ch]', '<p class="help-block">:message</p>') !!}
        </div>
        <div class="form-group {{ $errors->has('content') ? 'has-error' : ''}}">
            <label for="content_ch" class="control-label">{{ 'Описание CHI' }}</label>
            <input class="form-control" name="content[ch]" type="text" id="content_ch" value="{{ isset($technology->getContent->ch) ? $technology->getContent->ch : old('content.ch')}}" >
    ...
    <div class="tab-pane fade" id="custom-tabs-one-phr" role="tabpanel" aria-labelledby="custom-tabs-one-phr-tab">
        <div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
            ...
            <input class="form-control" name="title[phr]" type="text" id="title_phr" value="{{ isset($technology->getTitle->phr) ? $technology->getTitle->phr : old('title.phr')}}" >
            {!! $errors->first('title[phr]', '<p class="help-block">:message</p>') !!}
        </div>
        <div class="form-group {{ $errors->has('content') ? 'has-error' : ''}}">
            <label for="content_phr" class="control-label">{{ 'Описание PRS' }}</label>
            <input class="form-control" name="content[phr]" type="text" id="content_phr" value="{{ isset($technology->getContent->phr) ? $technology->getContent->phr : old('content.phr')}}" >
...
<div class="form-group {{ $errors->has('viewing') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="viewing" type="number" id="viewing" value="{{ isset($technology->viewing) ? $technology->viewing : ''}}" >
    {!! $errors->first('viewing', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('image') ? 'has-error' : ''}}">
    <label for="image" class="control-label">{{ 'Изображение' }}</label>
    <input class="form-control" name="image" type="file" id="image" value="{{ isset($technology->image) ? $technology->image : ''}}" >
...
<!-- <div class="col-md-12" style="padding: 0 !important"> -->
    <div class="form-group col-md-6 {{ $errors->has('video') ? 'has-error' : ''}}">
        ...
        <input class="form-control" name="video" type="file" id="video" value="{{ isset($technology->video) ? $technology->video : ''}}" >

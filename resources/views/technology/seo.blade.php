...
@section('title', 'Технология SEO')

@section('content_header')
    <h1>Технология SEO</h1>
@stop
@section('content')
    <div class="card-body">
        ...
        @endif
        <form method="POST" action="{{route('technologies-seo-store')}}" accept-charset="UTF-8"
            ...
            <div class="tab-content col-md-12" id="custom-tabs-one-tabContent">
                <div class="tab-pane active in" id="custom-tabs-one-ru" role="tabpanel"
                    ...
                    <div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
                        ...
                        <textarea class="form-control" name="title[ru]" type="text"
                                  id="title_ru">{{ isset($technology->metaTitle->ru) ? $technology->metaTitle->ru : old('title.ru')}}</textarea>
                ...
                {{ isset($technology->metaDescription->ru) ? $technology->metaDescription->ru : old('content.ru')}}
            </textarea>
                ...
                <div class="tab-pane fade" id="custom-tabs-one-en" role="tabpanel"
                    ...
                    <div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
                        ...
                        <input class="form-control" name="title[en]" type="text" id="title_en"
                               value="{{ isset($technology->metaTitle->en) ? $technology->metaTitle->en : old('title.en')}}">
                ...
                {{ isset($technology->metaDescription->en) ? $technology->metaDescription->en : old('content.en')}}
            </textarea>
                        {!! $errors->first('content[ru]"', '<p class="help-block">:message</p>') !!}
                    </div>
                </div>
                ...
                <div class="tab-pane fade" id="custom-tabs-one-kz" role="tabpanel"
                    ...
                    <div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
                        ...
                        <input class="form-control" name="title[kz]" type="text" id="title_kz"
                               value="{{ isset($technology->metaTitle->kz) ? $technology->metaTitle->kz : old('title.kz')}}">
                ...
                {{ isset($technology->metaDescription->kz) ? $technology->metaDescription->kz : old('content.kz')}}
            </textarea>
                ...
                <div class="tab-pane fade" id="custom-tabs-one-tr" role="tabpanel"
                    ...
                    <div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
                        ...
                        <input class="form-control" name="title[tr]" type="text" id="title_tr"
                               value="{{ isset($technology->metaTitle->tr) ? $technology->metaTitle->tr : old('title.tr')}}">
                ...
                {{ isset($technology->metaDescription->tr) ? $technology->metaDescription->tr : old('content.tr')}}
            </textarea>
                ...
                <div class="tab-pane fade" id="custom-tabs-one-ch" role="tabpanel"
                    ...
                    <div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
                        ...
                        <input class="form-control" name="title[ch]" type="text" id="title_ch"
                               value="{{ isset($technology->metaTitle->ch) ? $technology->metaTitle->ch : old('title.ch')}}">
                ...
                {{ isset($technology->metaDescription->ch) ? $technology->metaDescription->ch : old('content.ch')}}
            </textarea>
                ...
                <div class="tab-pane fade" id="custom-tabs-one-phr" role="tabpanel"
                    ...
                    <div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
                        ...
                        <input class="form-control" name="title[phr]" type="text" id="title_phr"
                               value="{{ isset($technology->metaTitle->phr) ? $technology->metaTitle->phr : old('title.phr')}}">
                ...
                {{ isset($technology->metaDescription->phr) ? $technology->metaDescription->phr : old('content.phr')}}
            </textarea>

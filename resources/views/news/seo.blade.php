    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{route('news-seo-store')}}" accept-charset="UTF-8"
            ...
            <div class="tab-content col-md-12" id="custom-tabs-one-tabContent">
                <div class="tab-pane active in" id="custom-tabs-one-ru" role="tabpanel"
                    ...
                    <div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
                        ...
                        <textarea class="form-control" name="title[ru]" type="text"
                                  id="title_ru">{{ isset($news->metaTitle->ru) ? $news->metaTitle->ru : old('title.ru')}}</textarea>
                ...
                {{ isset($news->metaDescription->ru) ? $news->metaDescription->ru : old('content.ru')}}
            </textarea>
                ...
                <div class="tab-pane fade" id="custom-tabs-one-en" role="tabpanel"
                    ...
                    <div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
                        ...
                        <input class="form-control" name="title[en]" type="text" id="title_en"
                               value="{{ isset($news->metaTitle->en) ? $news->metaTitle->en : old('title.en')}}">
                ...
                {{ isset($news->metaDescription->en) ? $news->metaDescription->en : old('content.en')}}
            </textarea>
                        {!! $errors->first('content[ru]"', '<p class="help-block">:message</p>') !!}
                    </div>
                </div>
                ...
                <div class="tab-pane fade" id="custom-tabs-one-kz" role="tabpanel"
                    ...
                    <div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
                        ...
                        <input class="form-control" name="title[kz]" type="text" id="title_kz"
                               value="{{ isset($news->metaTitle->kz) ? $news->metaTitle->kz : old('title.kz')}}">
                ...
                {{ isset($news->metaDescription->kz) ? $news->metaDescription->kz : old('content.kz')}}
            </textarea>
                ...
                <div class="tab-pane fade" id="custom-tabs-one-tr" role="tabpanel"
                    ...
                    <div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
                        ...
                        <input class="form-control" name="title[tr]" type="text" id="title_tr"
                               value="{{ isset($news->metaTitle->tr) ? $news->metaTitle->tr : old('title.tr')}}">
                ...
                {{ isset($news->metaDescription->tr) ? $news->metaDescription->tr : old('content.tr')}}
            </textarea>
                ...
                <div class="tab-pane fade" id="custom-tabs-one-ch" role="tabpanel"
                    ...
                    <div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
                        ...
                        <input class="form-control" name="title[ch]" type="text" id="title_ch"
                               value="{{ isset($news->metaTitle->ch) ? $news->metaTitle->ch : old('title.ch')}}">
                ...
                {{ isset($news->metaDescription->ch) ? $news->metaDescription->ch : old('content.ch')}}
            </textarea>
                ...
                <div class="tab-pane fade" id="custom-tabs-one-phr" role="tabpanel"
                    ...
                    <div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
                        ...
                        <input class="form-control" name="title[phr]" type="text" id="title_phr"
                               value="{{ isset($news->metaTitle->phr) ? $news->metaTitle->phr : old('title.phr')}}">
                ...
                {{ isset($news->metaDescription->phr) ? $news->metaDescription->phr : old('content.phr')}}
            </textarea>
